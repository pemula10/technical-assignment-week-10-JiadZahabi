...
TOKEN = "BBFF-0uwf2XOA8SDTQAElSRfgeNHktSXimB"  # Put your TOKEN here
DEVICE_LABEL = "sensor-ultrasonik"  # Put your device label here
VARIABLE_LABEL_1 = "distance"  # Put your first variable label here
VARIABLE_LABEL_2 = "kelemababan"  # Put your second variable label here
